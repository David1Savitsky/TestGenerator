...
namespace Library.Service
{
    public class ClassGenerationService
    {
        ...
        {
            Dictionary<string, int> methodsDictionary = GenerateMethodsCounts(classDeclaration);
            List<MemberDeclarationSyntax> testMethods = GenerateTestMethods(methodsDictionary);
        ...
        private Dictionary<string, int> GenerateMethodsCounts(ClassDeclarationSyntax classDeclaration)
        {
            ...
            Dictionary<string, int> methodsCounts = new Dictionary<string, int>();
